...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/libbg.png"/></div>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="MECH"/>MECH<input type="radio" name="branch" value="EC"/>EC<div style="margin-left:80px"><input type="radio" name="branch" value="CS"/>CS<input type="radio" name="branch" value="CIV"/>CIV</div>
            </div>   
